    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="lecturer">
                ...
                <p class = "content1">Giảng viên hướng dẫn: <br>Ths.Vũ Đình Minh</p>
                <p class = "content2">
            ...
            <div class="members">
                ...
                <ul style = "font-size: 1.3rem">
                    <li>Sinh viên: Hồ Văn Đức</li>
                    <li>Sinh viên:Vũ Tuấn Anh</li>
                    <li>Sinh viên: Dương Việt Anh</li>
                </ul>
        ...
        <div class="footer-bottom">
            <span>Copyright &copy; Group 15</span>
        </div>
    </div>
</footer>